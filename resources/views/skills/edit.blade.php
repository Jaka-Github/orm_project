...
<div class="max-w-3xl mx-auto p-4">
    <div class="flex items-center mb-6">
        <a href="{{ route('skills.index') }}" class="mr-4 text-blue-600 hover:text-blue-800">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        <form action="{{ route('skills.update', $skill->id) }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end pt-4">
                <a href="{{ route('skills.index') }}" class="btn btn-sm btn-ghost flex items-center gap-1 mr-3">
